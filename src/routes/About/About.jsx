...
export default function About() {
  const interestData = [
    {
      img: <i className="fa-solid fa-mobile-screen-button interestIcon"></i>,
    ...
    {
      img: <i className="fa-solid fa-gamepad interestIcon"></i>,
  ...
  return (
    <div className="about">
      ...
      <div className="aboutSection">
        <p>
          I am a Passionate Full Stack Developer. <br />I have the desire
